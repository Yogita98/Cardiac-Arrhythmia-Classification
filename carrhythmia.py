...
=======
basepath = os.path.dirname(__file__)
filename = os.path.join(basepath, 'models', 'xception_fine_tuned.h5')
>>>>>>> ef03f8c944f5330d5a31365cabc9877827be4449
...
=======
        basepath = os.path.dirname(__file__)
        filename = os.path.join(basepath, 'models', 'final_model_KSVM.sav')
>>>>>>> ef03f8c944f5330d5a31365cabc9877827be4449
